...
- **Formulário de contato** que salva no banco de dados e abre o WhatsApp automaticamente
...
| :--- | :--- |
| [Supabase](https://supabase.com) | Banco de dados PostgreSQL na nuvem com Row Level Security (RLS) |
...
```
djniel-presskit/
├── index.html        # Estrutura principal — Hero, Sobre, Repertório, Trajetória, Setup e Contato
├── style.css         # Estilos — variáveis CSS, layout, componentes, animações e responsividade
├── script.js         # Lógica — navbar, scroll reveal, menu mobile, Supabase e WhatsApp
...
| `criado_em` | `timestamptz` | ✅ | Data e hora do envio (automático) |
| `lida` | `boolean` | ✅ | Controle de leitura — padrão `false` |

> As mensagens podem ser visualizadas no painel do Supabase em **Table Editor → mensagens**.
...
Abra no navegador usando o **Live Server** do VS Code ou qualquer servidor local.

> ⚠️ Abrir o `index.html` diretamente pelo duplo clique (`file://`) pode causar problemas com o SDK do Supabase.
...
**Rhaniel Fabricio** — GitHub: [@RhanielFabricio](https://github.com/RhanielFabricio)
...
**DJ Niel**
Instagram: [@djniel011](https://instagram.com/djniel011) · WhatsApp: [Clique para conversar](https://wa.me/5511992346504)
